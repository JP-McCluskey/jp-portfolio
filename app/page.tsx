    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container flex h-14 items-center">
          <div className="mr-4 hidden md:flex">
            <Link className="mr-6 flex items-center space-x-2" href="/">
              <span className="hidden font-bold sm:inline-block">JP McCluskey</span>
            </Link>
          ...
          <a href="https://docs.google.com/document/d/1q60Thejw8TiBcO3ANdMSLdbZ6uWL5sW_SDhm091jg_g/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Full Stack Software Engineer with a passion for creating innovative and efficient solutions. Based in
                  Canada, I bring a diverse background and a unique blend of technical and leadership
                  expertise. With a Bachelor's degree in
                  Computer Engineering from Queen's University and  years of professional experience, I
                  specialize in JavaScript (React/TypeScript), Go, GraphQL, SQL, and more. My journey has taken me from
                  developing full-stack applications for startups like Tread and Javelin Sports to leading groups on
                  adventurous expeditions across Canada and Europe with Backroads, ALIVE Outdoors, and Camp Temagami.
                </p>
              </div>
              <div className="space-x-4">
                ...
                <Link href="https://www.linkedin.com/in/jeanphilippemccluskey/" target="_blank">
                  <Button variant="outline" size="icon">
      ...
      <footer className="border-t">
        <div className="container flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6">
          <p className="text-xs text-gray-500 dark:text-gray-400">© 2025 LuskeyLabs. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
